...
- [Container](https://github.com/docodex/gopkg/tree/master/container): Data Structures
  ...
  - [Dict (Map)](https://github.com/docodex/gopkg/tree/master/container/dict)
...
```sh
go get github.com/docodex/gopkg@latest
```

Or pin to a specific version (recommended for reproducible builds):

```sh
go get github.com/docodex/gopkg@v0.1.0
```
