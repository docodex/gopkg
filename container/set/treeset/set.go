...
// NewWithLock returns an initialized set with [cmp.Compare] as the cmp function for the backing
...
// NewFuncWithLock returns an initialized set with the given function cmp as the cmp function for
// the backing red-black tree and a sync.RWMutex to support concurrent use by multiple goroutines.
...
// Range calls f sequentially for each value v present in the set, in ascending
// order of the underlying tree's comparator.
