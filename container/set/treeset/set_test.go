...
func TestSet_IntersectionAndUnion(t *testing.T) {
	s1 := treeset.New(1, 2, 3, 4, 5)
	s2 := treeset.New(3, 4, 5, 6, 7)
	s3 := treeset.New(4, 5, 6, 7, 8, 9)
	s := treeset.New(s1.Len())
...
func TestSetIntersection(t *testing.T) {
	...
	intersection := treeset.New[string]()
...
func TestSetDifference(t *testing.T) {
	a := treeset.New[string]()
	b := treeset.New[string]()

	difference := treeset.New[string]()
