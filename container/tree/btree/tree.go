...
type Tree[K comparable, V any] struct {
	...
	// minSize: ceil(m/2)-1, minimum number of entries for nodes (except for the root and leaves)
...
// rightSibling returns the right sibling of node x and the corresponding child index (in parent)
